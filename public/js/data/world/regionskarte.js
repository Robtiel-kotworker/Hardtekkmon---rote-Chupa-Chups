...
/** @typedef {{ id: string, art: 'stadt'|'route', x: number, y: number, gig?: string, begegnung?: string }} Station */

/** @type {Station[]} */
export const STATIONEN = [
  { id: 'bassdorf', art: 'stadt', x: 120, y: 26 },
  { id: 'route1', art: 'route', x: 96, y: 58, begegnung: 'route1' },
  { id: 'schotterhausen', art: 'stadt', x: 130, y: 90, gig: 'gig8' },
  { id: 'route2', art: 'route', x: 92, y: 122, begegnung: 'route2' },
  { id: 'plattenwald', art: 'route', x: 58, y: 152, begegnung: 'plattenwald' },
  { id: 'kellerstadt', art: 'stadt', x: 84, y: 184, gig: 'gig1' },
  { id: 'hardtekk_city', art: 'stadt', x: 138, y: 202 },
  ...
  { id: 'subwoofer_city', art: 'stadt', x: 140, y: 306, gig: 'gig2' },
  { id: 'route5', art: 'route', x: 140, y: 338, begegnung: 'route5' },
  { id: 'vinylhafen', art: 'stadt', x: 140, y: 370, gig: 'gig3' },
  { id: 'route7', art: 'route', x: 176, y: 400, begegnung: 'route7' },
  { id: 'schranzheim', art: 'stadt', x: 208, y: 428, gig: 'gig4' },
  { id: 'route9', art: 'route', x: 182, y: 458, begegnung: 'route9' },
  { id: 'nebelmoor', art: 'stadt', x: 144, y: 484, gig: 'gig5' },
  { id: 'route10', art: 'route', x: 104, y: 510, begegnung: 'route10' },
  { id: 'donkhausen', art: 'stadt', x: 76, y: 540, gig: 'gig6' },
  { id: 'route11', art: 'route', x: 92, y: 570, begegnung: 'route11' },
  { id: 'glitchstadt', art: 'stadt', x: 128, y: 598, gig: 'gig7' },
